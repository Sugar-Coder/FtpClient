...
private:
    Q_DISABLE_COPY(QFtp) // QObject的宏，阻止默认的赋值和复制构造
    QScopedPointer<QFtpPrivate> d; //QScopedPointer guarantees that the object pointed to will get deleted when the current scope disappears.
